...
Wdrożenie polegało na uruchomieniu serwera z~bazą danych, jedną stację przekaźnikową oraz uruchomieniu 3`urządzeń pomiarowych.
...
Urządzenia zostały połączone z~czujnikami za pomocą zwykłych kabli prototypowych, jak na zdjęciu~\ref{rys:wezel1} i~\ref{rys:wezel2}.
Przykład urządzenia wykorzystującego wbudowane czujniki został zaprezentowany na zdjęciu~\ref{rys:wezel2}
...
Na ekranie urządzenia wyświetlane są informacje o~stanie urządzenia, jak na zdjęciu~\ref{rys:stacja1}.
...
Wszystkie urządzenia zostały skonfigurowane tak, aby połączyć się z~bazą danych za pomocą tego tokenu.
Niestety, nie zostało użyte szyfrowanie TLS.
...
Przejścia dla temperatury i~wilgotności były bardzo płynne, (co widać na rysunku) co świadczy o~poprawności działania systemu.
...
Testy zostały przeprowadzone w następujący sposób: z~3~węzłów sieci były emitowane pakiety w bardzo krótkich odstępach czasu (co 10 sekund).
...
Wszystkie pakiety były odbierane równie przez stację przekaźnikową.
...
Niektóre czujniki traciły zasilanie przez nieuważne zmiany kabli zasilających czy niezmienianie baterii na czas.
