...
Najczęściej układ te są wykorzystywane różnych projektach IoT, zarówno jako czujniki, jak i~serwery~\cite{ESP32:datasheet}.


%  PROJECTS
W projekcie ESP32 zostało wykorzystane w dwóch płytkach TTGO T3 LoRa32 V1.6.1.
...
Płytka ta jest często wykorzystywana zarówno przez hobbystów do różnych projektów IoT, a~także jako sterownik silników, czy kontroler robotów, jak i jest szeroko używana w przemyśle~\cite{PICO:doc}.
