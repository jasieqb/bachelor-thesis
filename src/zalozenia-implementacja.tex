...
\begin{itemize}
    ...
    \item zapisywanie danych do bazy danych szeregówczasowych, w celu ich dalszego przetwarzania,
...
Redis jest szybką, otwartoźródłową, nierelacyjną bazą danych typu \emph{klucz-wartość}, która jest szeroko stosowana w~systemach informatycznych~\cite{tool:redis}.
